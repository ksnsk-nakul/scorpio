...
async function mountPage(author, books) {
  const { default: AnimejsAuthorShow } = await import('@/Pages/Public/Templates/Animejs/AuthorShow.vue')
  return mount(AnimejsAuthorShow, { props: { author, books } })
}

describe('Animejs AuthorShow template', () => {
