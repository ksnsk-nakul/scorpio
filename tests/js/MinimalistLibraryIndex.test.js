...
async function mountPage(books) {
  const { default: MinimalistLibraryIndex } = await import('@/Pages/Public/Templates/Minimalist/LibraryIndex.vue')
  return mount(MinimalistLibraryIndex, { props: { books } })
}

describe('Minimalist LibraryIndex template', () => {
