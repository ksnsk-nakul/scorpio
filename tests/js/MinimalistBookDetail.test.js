...
async function mountPage(book) {
  const { default: MinimalistBookDetail } = await import('@/Pages/Public/Templates/Minimalist/BookDetail.vue')
  return mount(MinimalistBookDetail, { props: { book } })
}

describe('Minimalist BookDetail template', () => {
