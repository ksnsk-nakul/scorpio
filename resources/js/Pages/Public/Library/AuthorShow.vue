<template>
  <component v-if="activeTemplateComponent" :is="activeTemplateComponent" :author="author" :books="books" />
...
const activeTemplateComponent = computed(() => resolvePublicPage(publicTemplate.value, 'AuthorShow'))
</script>
