<template>
  ...
  <div class="min-h-screen bg-white text-slate-900 font-sans">
    ...
    <!-- ── Nav ───────────────────────────────────────────────────────────
         ...
         brand-only bar (never MinimalistNav, which always shows the Library
         link, auth CTA and mobile menu). -->
    <MinimalistNav v-if="!organization.white_label" :settings="settings" />
    ...
    <!-- ── Footer ────────────────────────────────────────────────────────
         White-labeled orgs get NO footer at all (no MinimalistFooter, no
         "Powered by" strip, nothing) — matching the original exactly. -->
    <MinimalistFooter v-if="!organization.white_label" :settings="settings" />
  </div>
</template>
