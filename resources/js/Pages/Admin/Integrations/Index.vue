<template>
  <AdminLayout>
    <div class="max-w-2xl mx-auto">
      <h1 class="text-2xl font-bold text-slate-800 mb-6">Integrations</h1>
      ...
      <!-- Flash -->
      <div v-if="$page.props.flash?.success" class="mb-5 bg-green-50 border border-green-200 text-green-800 text-sm rounded-xl px-4 py-3">
        {{ $page.props.flash.success }}
      </div>
      <div v-if="$page.props.flash?.error" class="mb-5 bg-red-50 border border-red-200 text-red-800 text-sm rounded-xl px-4 py-3">
